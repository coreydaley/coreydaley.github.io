...
image = "/images/posts/software-factory.webp"
+++

{{< figure-float src="/images/posts/software-factory.webp" alt="Developers at monitors working around a holographic AI brain and glowing circuit-board city with robotic arms" >}}
...
{{< figure-block src="/images/posts/attractor-screenshot-create.webp" alt="Attractor web dashboard Create view showing a natural language project description, generated DOT source, and a live graph preview of a Go Hello World CLI pipeline" width="100%" >}}
...
{{< figure-block src="/images/posts/digraph-dot-graph.webp" alt="DOT source code for a PR pipeline alongside its rendered directed graph, showing start, plan, implement, test, check, review, and exit nodes" width="100%" >}}
...
{{< figure-block src="/images/posts/attractor-screenshot-run.webp" alt="Attractor Monitor dashboard showing a completed pipeline run named Sleek-Tortoise-707 with all stages checked green, elapsed time, and the pipeline graph rendered on the right" width="100%" >}}
