...
image = "accessible-website.webp"
+++

{{< figure-float src="accessible-website.webp" alt="Person wearing headphones using laptop showing an accessible website interface" >}}
