...
function checkSpecialDateAvatar() {
  ...
  if (month === 1 && day === 1) {
    avatar.src = "/images/avatar-newyears.png";
    return;
  }
  ...
  if (month === 3 && day === 17) {
    avatar.src = "/images/avatar-stpatricks.png";
    return;
  }
  ...
  if (month === 5 && day === 5) {
    avatar.src = "/images/avatar-cincodemayo.png";
    return;
  }
  ...
  if (day === 13 && dayOfWeek === 5) {
    avatar.src = "/images/avatar-friday13.png";
    return;
  }
}
